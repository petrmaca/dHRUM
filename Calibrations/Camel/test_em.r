...
prec=c(1,2,3)
temp=c(1,2,3)
gwStorTypesVec <- c("LINBY_RES", "LIN_RES", "FLEX_RES")
setGWtypeToAlldHrus(dHRUM_ptr = dhrus, gwStorTypesVec, c("ID1", "ID2", "ID3"))
...
ParDF = data.frame( B_SOIL = 1.6, C_MAX = 100, B_EVAP = 2,  KS = 0.1, KF = 0.2, ADIV = 0.3, CDIV = 0.03,
                    SDIV = 0.03, CAN_ST = 2, STEM_ST = 2, CSDIV = 0.3, TETR = 5, DDFA = 0.5, TMEL = 0, RETCAP = 10, D_BYPASS = 0.8, THR = 10, KS2 = 0.1 )
