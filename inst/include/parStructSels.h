...
enum class par_HRUtype {B_SOIL, C_MAX, B_EVAP, SMAXpdm, KS, KF, ADIV, CDIV, SDIV, CAN_ST, STEM_ST, CSDIV, TETR, DDFA, TMEL, \
                        ...
                        WP, SMAX, RBAI, RBEI,KFR,INTstMax,CSfrac, INTstScale,WtlnFrac,SRFrac,Kinct,KwPe};
const par_HRUtype all_pars[]{par_HRUtype::B_SOIL, par_HRUtype::C_MAX, par_HRUtype::B_EVAP, par_HRUtype::SMAXpdm, par_HRUtype::KS, par_HRUtype::KF,      \
                             ...
                             par_HRUtype::INTstScale,par_HRUtype::WtlnFrac, par_HRUtype::SRFrac,par_HRUtype::Kinct,par_HRUtype::KwPe};
...
const std::vector<std::string> allParNames {"B_SOIL","C_MAX","B_EVAP", "SMAXpdm","KS","KF","ADIV","CDIV", \
                                            ...
                                            "INTstScale","WtlnFrac","SRFrac","Kinct","KwPe"};
...
enum class interception_STORtype { Rutter_Gash, van_Dijk, Eliades};
...
enum class lai_SmaxModel {Pitman, VonHoyningenHuene};
const lai_SmaxModel all_LaiSMax[] {lai_SmaxModel::Pitman, lai_SmaxModel::VonHoyningenHuene};
const std::vector<std::string> lai_SMAXtypeNames {"Pitman","VonHoyningenHuene"};
...
const std::list<par_HRUtype> L_SurfacePRTL = { par_HRUtype::SRFrac, par_HRUtype::RETCAP };
const std::list<par_HRUtype> L_Wetland = {par_HRUtype::WtlnFrac, par_HRUtype::Kinct, par_HRUtype::KwPe};
//intrc_STORAGE
...
const std::list<par_HRUtype> L_van_Dijk = { par_HRUtype::INTstMax, par_HRUtype::CSfrac, par_HRUtype::INTstScale};
const std::list<par_HRUtype> L_Eliades = { par_HRUtype::INTstMax, par_HRUtype::CSfrac, par_HRUtype::INTstScale};
//gs_STORAGE
...
const std::list<par_HRUtype> L_LINBY_RES = { par_HRUtype::KS, par_HRUtype::ADIV, par_HRUtype::D_BYPASS };
const std::list<par_HRUtype> L_POW_RES = { par_HRUtype::KS, par_HRUtype::ADIV, par_HRUtype::B_EXP };
const std::list<par_HRUtype> L_EXP_RES = { par_HRUtype::KS, par_HRUtype::ADIV, par_HRUtype::B_EXP };
const std::list<par_HRUtype> L_LIN_2SE = { par_HRUtype::KS, par_HRUtype::ADIV, par_HRUtype::KS2 };
const std::list<par_HRUtype> L_LIN_2PA = { par_HRUtype::KS, par_HRUtype::ADIV, par_HRUtype::KS2, par_HRUtype::ALPHA };
...
const std::list<par_HRUtype> L_SBROOK_V1 = { par_HRUtype::KF, par_HRUtype::FC, par_HRUtype::FOREST_FRACT, par_HRUtype::KF_NONLIN, par_HRUtype::SMAX};
const std::list<par_HRUtype> L_HILLSLOPE = { par_HRUtype::KF, par_HRUtype::KF_NONLIN, par_HRUtype::SMAX};
const std::list<par_HRUtype> L_PLATEAU = { par_HRUtype::C, par_HRUtype::INFR_MAX, par_HRUtype::RF, par_HRUtype::WP, par_HRUtype::SMAX};
const std::list<par_HRUtype> L_PDM2 = { par_HRUtype::B_SOIL, par_HRUtype::C_MAX };
//fast_response
const std::list<par_HRUtype> L_SerialCascadeLinRes = { par_HRUtype::KFR, par_HRUtype::ADIV };
const std::list<par_HRUtype> L_SerialLinResGWGros = { par_HRUtype::KFR, par_HRUtype::ADIV,par_HRUtype::RBEI };
const std::list<par_HRUtype> L_SerialLinResSoilSois = { par_HRUtype::KFR, par_HRUtype::ADIV,par_HRUtype::RBAI };
const std::list<par_HRUtype> L_SerialLinResGWGrosSoilSois = { par_HRUtype::KFR, par_HRUtype::ADIV,par_HRUtype::RBEI, par_HRUtype::RBAI };
//other
