...
class single_HMunit {
 public:
  ...
  void get_InterceptionsSmax(interception_STORtype _intrc_STORAGE);
...
private:
  ...
  numberSel prev_IntSnow;//!< The helper variable for updating dual state interception model intercepted snow, canopy storage for Rutter type models
  numberSel prev_StemSnow;//!< The helper variable for updating dual state interception model intercepted snow, stem storage for Rutter type models
