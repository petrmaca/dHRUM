...
enum class ts_type {PREC,SNOW,AET,PET,TEMP,MELT,MELV,TROF,STEF,CANF,CANS,STES,EVAC,EVAS,EVBS,INTS,SOIS,GROS,SURS,TOTR,BASF,DIRR,PERC,PREF,ETSW,PONS,ETPO,POIS,POIG,LAI,INFL,TRNS};
const ts_type all_ts[]{ts_type::PREC,ts_type::SNOW,ts_type::AET,ts_type::PET,ts_type::TEMP,ts_type::MELT,ts_type::MELV,ts_type::TROF,ts_type::STEF,ts_type::CANF, \
                                   ...
                                   ts_type::ETPO,ts_type::POIS,ts_type::POIG,ts_type::LAI,ts_type::INFL,ts_type::TRNS};


const unsigned numTSvars = 32;
