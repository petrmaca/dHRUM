...
enum class interception_type { Rutter_Gash};

const interception_type all_Interceptions[]{ interception_type::Rutter_Gash};

const std::vector<std::string> allTnterceptionTypeNames {"Rutter_Gash"};
