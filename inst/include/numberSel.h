...
enum class pet_Type {OUDIN, HAMON, THORNTHWAITE};

const std::vector<std::string> allPetNames {"OUDIN", "HAMON", "THORNTHWAITE"};
...
enum class par_HRUtype {B_SOIL, C_MAX, B_EVAP, SMAX, KS, KF, ADIV, CDIV, SDIV, CAN_ST, STEM_ST, CSDIV, TETR, DDFA, TMEL, RETCAP};
